...
class PhraseTrigger(Trigger):
    ...
    def __init__(self, phrase):
        ...
        '''
        valid phrases do NOT contain punctuation
        '''
...
class TitleTrigger(PhraseTrigger): 
    ...
    def evaluate(self, story):
        title_text = story.get_title()
        return PhraseTrigger.is_phrase_in(self, title_text)
...
class DescriptionTrigger(PhraseTrigger):
    ...
    def evaluate(self, story):
        description_text = story.get_description()
        return PhraseTrigger.is_phrase_in(self, description_text)
...
def main_thread(master):
    ...
    try:
        ...
        while True:
            ...
            # Katie - commented out this line because Yahoo news is very out of date
