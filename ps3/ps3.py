...
def get_word_score(word, n):
    ...
    num = 7 * len(word) - 3 * (n - len(word))
    
    if num > 1:
        second_component = num 
    else: 
        second_component = 1 
...
def play_hand(hand, word_list):
    ...
    * The hand finishes when there are no more unused letters.
    ...
    while not calculate_handlen(hand) == 0: 
        ...
        if word == "!!": 
            ...
            print("You have ended this round. ")
            break
        ...
        # Otherwise (the input is not two exclamation points):
            ...
            if is_valid_word(word, hand, word_list): 
                ...
                this_word_score = get_word_score(word, n)
                print(word + " earned " + str(this_word_score), end=". ")
                
                # and the updated total score
                total_score += this_word_score
                print("Total score of this hand so far: " + str(total_score))
    ...
    print("Total score of this hand: " + str(total_score))
    return total_score
    ...
    * Returns the total score for the series of hands
    ...
    while i < total_num_of_hands: 
        ...
        if sub_bool: 
            ...
            if substitution == "yes":
                letter = input("Which letter would like to replace: ").lower()
        ...
        if not replay_bool: 
            # is user has not replayed 
            replay = input("Would you like to replay this hand? ").lower()
            if replay == "yes":
                replay_score = play_hand(hand, word_list) 
                replay_bool = True
                total_score_all_hands += max(replay_score, this_hand_score)
            else: 
                total_score_all_hands += this_hand_score
                i += 1
        else: 
            total_score_all_hands += this_hand_score
            i += 1
        
    print("Total score over all hands: " + str(total_score_all_hands))
